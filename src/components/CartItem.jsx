...
const CartItem = () => {
  ...
  return (
    <div className=" flex flex-col justify-start items-start gap-6 md:gap-4 p-5 py-4 overflow-y-scroll scroll-smooth h-[80vh] md:scroll-hidden">
      {cartItems.map((items) => {
        const { title, text, color, shadow, cartQuantity, price, img } = items;
        return (
